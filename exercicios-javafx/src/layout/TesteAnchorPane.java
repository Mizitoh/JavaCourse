...
public class TesteAnchorPane extends AnchorPane{
	...
	public TesteAnchorPane() {
		...
		setBottomAnchor(centro, 110.0); /* 
									   *numeros referente ao tamanho da caixa, 
									   * o hbox é responsivel o que vai ajuda a centralizar o proximo quadrado
									   */
		...
		//igual ancorar divs flutuantes, do curso de web
	}
